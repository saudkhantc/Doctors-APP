  ...
  return (
    <>
      <div className="md:p-5 bg-[#F0F7FC] md:h-screen">
        ...
        <div className="flex flex-wrap md:justify-start justify-center h-fit">
          <div className="md:ps-5 mt-20 md:flex bg-[#007ACC] md:w-[360px] md:gap-10 p-5 rounded-lg md:ms-10">
            <div className=" ">
